...
- 游戏：Meow Machine
- 类型：tool
- 简述：Tap. Cats sing. — 8 cats × 8 steps, three moods (NAP / PARTY / ZOOMIES), one shuffle button, zero training required
- 框架 / 语言 / 构建：JavaScript, Vite
- 渲染方式：DOM/CSS
- 依赖摘录：vite@^5.1.0
- 平台元信息：meta.title=Meow Machine；cover_url=/poster.png；category=tool；uuid=7824cec6-9510-44be-809f-e2253504a561
